...
class RedirectTest
  def initialize
    ...
    @urls_to_redirect = [
      ...
      {old: '/AboutTheGC/IntegrityMeasures/index.html', new: '/about/integrity-measures'},
      ...
      {old: '/Issues/partnerships/index.html', new: '/take-action/partnerships'},
      {old: '/Issues/partnerships/post_2015_development_agenda.html', new: '/what-is-gc/our-work/sustainable-development/'},
      ...
      {old: '/Issues/human_rights/Human_Rights_Working_Group.html', new: '/what-is-gc/our-work/social/human-rights/working-group'},
      ...
      {old: '/HowToParticipate/Business_Participation/index.html', new: '/participation/join'},
      {old: '/HowToParticipate/cities.html', new: '/participation/join/who-should-join/non-business'},
      {old: '/HowToParticipate/civil_society/index.html', new: '/participation/join/who-should-join/non-business'},
      {old: '/HowToParticipate/academic_network/index.html', new: '/participation/join/who-should-join/non-business'},
      {old: '/HowToParticipate/business_associations.html', new: '/participation/join/who-should-join/non-business'},
      {old: '/HowToParticipate/non_business_participation/public_sector_organization.html', new: '/participation/join/who-should-join/non-business'},
      ...
      {old: '/AboutTheGC/Global_Compact_Logo/index.html', new: '/participation/getting-started/brand-guidelines'},
      {old: '/AboutTheGC/Global_Compact_Logo/GC_Logo_Policy.html', new: '/participation/getting-started/brand-guidelines'},
      {old: '/AboutTheGC/guide_to_corporate_sustainability.html', new: '/library/1151'},
      {old: '/Issues/index.html', new: '/what-is-gc/our-work/'},
      {old: '/HowToParticipate/Lead/index.html', new: '/take-action/leadership/gc-lead'},
      {old: '/HowToParticipate/Lead/participation.html', new: '/take-action/leadership/gc-lead'},
      {old: '/HowToParticipate/Lead/lead_participants.html', new: '/what-is-gc/participants'},
      ...
      {old: '/Issues/conflict_prevention/local_network_activities.html', new: '/take-action/action/peace-local-activities'},
      ...
      {old: '/Issues/human_rights/business_for_the_rule_of_law.html', new: '/take-action/action/business-rule-of-law'},
      ...
      {old: '/Issues/transparency_anticorruption/collective_action.html', new: '/take-action/action/anti-corruption-collective-action'},
      ...
      {old: '/AboutTheGC/The_Global_Compact_Board/meetings.html', new: '/library/1821'},
      {old: '/NetworksAroundTheWorld/index.html', new: '/engage-locally'},
      ...
      {old: '/AboutTheGC/Internship_at_the_Global_Compact/index.html', new: '/about/opportunities/internships'},
      ...
      {old: '/NewsAndEvents/UNGC_bulletin/subscribe.html', new: '/news/bulletin'},
      ...
      {old: '/NewsAndEvents/UNGC_bulletin/2014_01_01.html', new: '/library/search?search[content_type]=4'},
