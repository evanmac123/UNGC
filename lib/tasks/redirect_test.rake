...
class RedirectTest
  def initialize
    ...
    @urls_to_redirect = [
      ...
      {old: '/NewsAndEvents/UNGC_bulletin/subscribe_email_sent.html', new: '/news/bulletin/confirmation'},
      {old: '/NewsAndEvents/UNGC_bulletin/unsubscribe.html', new: '/news/bulletin/unsubscribe'},
