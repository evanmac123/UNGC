...
UNGC::Application.routes.draw do
  ...
  namespace :sitemap, path: '/sitemap' do
    namespace :api, format: :json do
      ...
      resources :taggings, only: [
        ...
        get :action_platforms, on: :collection
      end
      resources :images do
  ...
  get '/MGGLB', to: redirect('/take-action/events/1611-making-global-goals-local-business-argentina')
  get '/library/5625', to: redirect('/library/5644')
  get '/library/5361', to: redirect('/library/5643')
  ...
  get '/what-is-gc/our-work/sustainable-development/sdgs/17-global-goals', to: redirect('/sdgs/17-global-goals')
  get '/what-is-gc/our-work/sustainable-development/global-goals-local-business', to: redirect('/sdgs')
  get '/what-is-gc/our-work/sustainable-development/global-goals-local-business/ln-action-plan', to: redirect('/sdgs/ln-action-plan')
  get '/what-is-gc/our-work/sustainable-development/global-goals-local-business/sdg-toolbox', to: redirect('/sdgs/sdg-toolbox')
  get '/what-is-gc/our-work/sustainable-development/global-goals-local-business/sdg-solutions-platforms', to: redirect('/sdgs/sdg-solutions-platforms')
  get '/what-is-gc/our-work/sustainable-development/global-goals-local-business/faq', to: redirect('/sdgs/sdgpioneers/faq')
  get '/what-is-gc/our-work/sustainable-development/global-goals-local-business/sdgpioneers', to: redirect('/sdgs/sdgpioneers')
  get '/what-is-gc/our-work/sustainable-development/global-goals-local-business/sdgpioneers/2016', to: redirect('/sdgs/sdgpioneers/2016')
  get '/what-is-gc/our-work/sustainable-development/global-goals-local-business/sdgpioneers/2016/kerry-adler', to: redirect('/sdgs/sdgpioneers/2016/kerry-adler')
  get '/what-is-gc/our-work/sustainable-development/global-goals-local-business/sdgpioneers/2016/ulysses-smith', to: redirect('/sdgs/sdgpioneers/2016/ulysses-smith')
  get '/what-is-gc/our-work/sustainable-development/global-goals-local-business/sdgpioneers/2016/dina-sherif', to: redirect('/sdgs/sdgpioneers/2016/dina-sherif')
  get '/what-is-gc/our-work/sustainable-development/global-goals-local-business/sdgpioneers/2016/ulisses-matiolli-sabara', to: redirect('/sdgs/sdgpioneers/2016/ulisses-matiolli-sabara')
  get '/what-is-gc/our-work/sustainable-development/global-goals-local-business/sdgpioneers/2016/claus-stig-pedersen', to: redirect('/sdgs/sdgpioneers/2016/claus-stig-pedersen')
  get '/what-is-gc/our-work/sustainable-development/global-goals-local-business/sdgpioneers/2016/patrick-ngowi', to: redirect('/sdgs/sdgpioneers/2016/patrick-ngowi')
  get '/what-is-gc/our-work/sustainable-development/global-goals-local-business/sdgpioneers/2016/xiaohui-liang', to: redirect('/sdgs/sdgpioneers/2016/xiaohui-liang')
  get '/what-is-gc/our-work/sustainable-development/global-goals-local-business/sdgpioneers/2016/sonia-consiglio-favaretto', to: redirect('/sdgs/sdgpioneers/2016/sonia-consiglio-favaretto')
  get '/what-is-gc/our-work/sustainable-development/global-goals-local-business/sdgpioneers/2016/farzana-chowdhury', to: redirect('/sdgs/sdgpioneers/2016/farzana-chowdhury')
  get '/what-is-gc/our-work/sustainable-development/global-goals-local-business/sdgpioneers/2016/zubaida-bai', to: redirect('/sdgs/sdgpioneers/2016/zubaida-bai')
