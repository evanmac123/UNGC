...
UNGC::Application.routes.draw do
  ...
  namespace :redesign, path: '/', constraints: RedesignConstraint.new do
    ...
    get '/AboutTheGC/The_Global_Compact_Board/meetings.html'=> 'static#redirect_to_page', page: '/take-action/events'
    ...
    get '/AboutTheGC/Internship_at_the_Global_Compact/index.html'=> 'static#redirect_to_page', page: '/about/opportunities'
    ...
    get '/Languages/chinese/index.html'=> 'static#redirect_to_page', page: '/'
    get '/Languages/french/index.html'=> 'static#redirect_to_page', page: '/'
    get '/Languages/russian/index.html'=> 'static#redirect_to_page', page: '/'
    get '/Languages/spanish/index.html'=> 'static#redirect_to_page', page: '/'
    get '/Languages/german/index.html'=> 'static#redirect_to_page', page: '/'
    get '/Languages/portuguese/index.html'=> 'static#redirect_to_page', page: '/'
