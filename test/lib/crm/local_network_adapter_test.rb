...
module Crm
  class LocalNetworkAdapterTest < ActiveSupport::TestCase
    ...
    test "It converts local network id to the format that the CRM expects" do
      assert_equal "LN-001", LocalNetworkAdapter.convert_id(1)
      assert_equal "LN-012", LocalNetworkAdapter.convert_id(12)
      assert_equal "LN-123", LocalNetworkAdapter.convert_id(123)
    end
    ...
    test "it converts Country__c" do
      ...
      converted = LocalNetworkAdapter.new.to_crm_params(local_network)
