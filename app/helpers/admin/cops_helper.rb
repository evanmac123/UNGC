module Admin::CopsHelper
  ...
  def true_or_false_cop_attributes(cop, attributes)
    ...
    answers.each do |answer|
      ...
      cop_attribute_text_content += '&nbsp;&nbsp;' + image_tag('/assets/icons/Info_11x11.png', :style => 'margin-bottom: -2px;', :title => answer.cop_attribute.hint) if answer.cop_attribute.hint.present?
