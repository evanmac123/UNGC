class PagesController < ApplicationController
  helper %w{application cops datetime events local_network navigation news organizations pages participants search sessions signatories signup stakeholders} # needs to be explicit
